...
do
  ...
  ./scripts/multi_rsu_congestion_with_immu_single_experiment.sh $PROPOSER_NUM $VALIDATOR_NUM $MESSAGE_SIZE $NETWORK_DELAY $VEHICLE_SPEED $COM_POSSIBILITY_FLAG $ALLOW_BYPASS_FLAG $main_proposer
