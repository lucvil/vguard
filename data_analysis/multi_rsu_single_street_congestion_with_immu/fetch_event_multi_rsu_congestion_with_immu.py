...
if allow_bypass_flag:
    result_csv_folder = "./results/multi_rsu_single_street_congestion_with_immu/vs"  + str(vehicle_speed) + "/n" + str(participant_size) + "/m" + str(message_size) + "/d" + str(network_delay) + "/" + str(main_proposer_id) + "/"
else:
    result_csv_folder = "./results/multi_rsu_single_street_congestion_with_immu/vs"  + str(vehicle_speed) + "/n" + str(participant_size) + "/m" + str(message_size) + "/d" + str(network_delay) + "/" + str(main_proposer_id) + "/"
