...
for proposer_id in proposer_list:
    ...
    if allow_bypass_flag:
        result_csv_folder = "./results/bypass_route/vs"  + str(vehicle_speed) + "/n" + str(participant_size) + "/m" + str(message_size) + "/d" + str(network_delay) + "/" + str(proposer_id) + "/"
    else:
        result_csv_folder = "./results/no_bypass_route/vs"  + str(vehicle_speed) + "/n" + str(participant_size) + "/m" + str(message_size) + "/d" + str(network_delay) + "/" + str(proposer_id) + "/"
...
for validator_id in validator_list:
    ...
    for proposer_id in proposer_list:
        if allow_bypass_flag:
            result_csv_folder = "./results/bypass_route/vs"  + str(vehicle_speed) + "/n" + str(participant_size) + "/m" + str(message_size) + "/d" + str(network_delay) + "/" + str(proposer_id) + "/"+ str(validator_id) + "/"
        else:
            result_csv_folder = "./results/no_bypass_route/vs"  + str(vehicle_speed) + "/n" + str(participant_size) + "/m" + str(message_size) + "/d" + str(network_delay) + "/" + str(proposer_id) + "/"+ str(validator_id) + "/"
